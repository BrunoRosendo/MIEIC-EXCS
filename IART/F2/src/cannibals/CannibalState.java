...
public class CannibalState extends CostfulState {
    ...
    public CannibalState(int nMisStart, int nCanStart) {
        this(nMisStart, nCanStart, 0, 0, BoatPos.START, null, 0);
    }

    private CannibalState(int nMisStart, int nCanStart, int nMisDest, int nCanDest,
                          final BoatPos boatPos, final CannibalState parent, final int transitionCost) {
    ...
    public int getHeuristicCost() {
        return nMisStart + nCanStart - nMisDest - nCanDest;
    }
}
